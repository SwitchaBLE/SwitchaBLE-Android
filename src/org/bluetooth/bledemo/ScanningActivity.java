...
//            	break;
    ...
    protected void onListItemClick(ListView l, View v, int position, long id) {
        ...
        final Intent intent = new Intent(this, HRDemoActivity.class);
        intent.putExtra(HRDemoActivity.EXTRAS_DEVICE_NAME, device.getName());
        intent.putExtra(HRDemoActivity.EXTRAS_DEVICE_ADDRESS, device.getAddress());
        intent.putExtra(HRDemoActivity.EXTRAS_DEVICE_RSSI, mDevicesListAdapter.getRssi(position));
